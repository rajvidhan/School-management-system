...
console.log(student)
  const handleSubmit = async (e) => {
    ...
    formData.append("previousschool",student.previousschool)

    const toastId2 = toast.loading("Student Adding...");
    await axios
      .post("http://localhost:3000/admin/add-student",formData)
      .then((result) => {
        ...
        <form className="row g-1 " onSubmit={handleSubmit}>
          ...
          <div className="col-12">
            ...
            <input
              ...
              autoComplete="off"
              onChange={(e) =>
                setStudent({ ...student, previousschool: e.target.value })
              }
            />
          </div>
